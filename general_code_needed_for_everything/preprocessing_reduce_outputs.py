...
'''
# This is the first file we executed, running this creates a outputevents_reduced.pkl that is stored in the 
# data directory we created. The purpose of this preprocessing file is to remove data that is not complete

from hyperparameters import Hyperparameters as hp #to import the Hyperparameters class from the hyperparameters.py file as this file defines the paths for the data directories
import pandas as pd
import pickle
